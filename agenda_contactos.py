...
def agregar_contacto(agenda):
    nombre = input("Por favor ontrodizca el nombre completo del contacto: ")
...
def eliminar_contacto(agenda):
    ...
    if nombre in agenda:
        del agenda[nombre]
        print("EL contacto de {nombre} aha sido eliminado correctamente")
    else:
...
def agenda_contactos():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            print("Saliendo de la agenda de contactos ¡Hata luego!")
            break
        else:
